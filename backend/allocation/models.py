...
class Classroom(models.Model):
    ...
    class_teacher = models.ForeignKey('accounts.Account', on_delete=models.SET_NULL, null=True, related_name='classrooms_leading', limit_choices_to={'group': 'Teacher'})
    other_teachers = models.ManyToManyField('accounts.Account', related_name='classrooms_assisting', limit_choices_to={'group': 'Student'})
