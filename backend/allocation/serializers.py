...
class ClassroomSerializer(serializers.ModelSerializer):
    ...
    other_teachers_details = AccountSerializer(source='other_teachers', many=True, read_only=True)

    class Meta:
        model = Classroom
        fields = [
            'id', 'name', 'is_active', 'standard',
            'students', 'students_details',
            'class_teacher', 'class_teacher_details',
            'other_teachers', 'other_teachers_details'
        ]
...
class SubjectSerializer(serializers.ModelSerializer):
    ...
    other_teachers_details = AccountSerializer(source='other_teachers', many=True, read_only=True)
    additional_students_details = AccountSerializer(source='additional_students', many=True, read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'main_teacher', 'main_teacher_details',
            'other_teachers', 'other_teachers_details',
